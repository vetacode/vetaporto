...
const buttonVariants = cva(
  'flex-center shrink-0 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-neutral-25 rounded-full text-sm-medium font-medium text-neutral-950 hover:ring-3 hover:shadow-[0_0_17px_rgba(255,255,255,0.9)] hover:ring-primary-300 active:ring-5 active:bg-primary-100 transition-all duration-200 ease cursor-pointer',
